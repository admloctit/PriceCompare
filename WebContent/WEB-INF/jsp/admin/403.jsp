...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/eliteadmin-ecommerce/403.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Jun 2017 08:56:52 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="${pageContext.request.contextPath }/admin/process-logout.html" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to login</a> </div>
            <footer class="footer text-center">2018 © TV Admin.</footer>
        </div>
    </section>
    <!-- jQuery -->
