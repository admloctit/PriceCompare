	...
	<h4 class="text-red">${errors }</h4>
		...
		<div class="table-responsive">
			<table id="myTable" class="table table-striped no-footer" role="grid">
				...
				<tbody>
					<c:forEach var="brand" items="${brandes }">
						<tr class="gradeA" role="row">
							<td>${brand.id }</td>
							<td>${brand.name }</td>
							<td><a
								href="${pageContext.request.contextPath }/admin/brand/edit/${brand.id }.html">Edit</a>
								| <a
								href="${pageContext.request.contextPath }/admin/brand/delete/${brand.id }.html"
